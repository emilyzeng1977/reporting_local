...
resource "aws_ecs_service" "nginx" {
  ...
  depends_on = [ aws_ecs_cluster.main, aws_lb_listener.front_end, aws_iam_role_policy_attachment.ecs_task_execution_role, aws_security_group.nginx_task ]
}
...
resource "aws_ecs_service" "app" {
  ...
  depends_on = [ aws_ecs_cluster.main, aws_lb_listener.front_end, aws_iam_role_policy_attachment.ecs_task_execution_role, aws_security_group.app_task ]
}
